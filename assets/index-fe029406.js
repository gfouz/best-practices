import{s as e,j as a,F as g,a as t,L as d,r as n}from"./index-1626cff6.js";import{F as x}from"./Footer-e7d4da1f.js";import{L as h,M as s}from"./MotionOnScroll-6a2a7a1e.js";import{m as z,P as k,F as M}from"./FramerMotions-18d1b54a.js";const L=()=>a(g,{children:[t(m,{children:t(d,{to:"/about",children:"about"})}),t(m,{children:t(d,{to:"/contact",children:"contact"})}),t(m,{children:t(d,{to:"/curriculum",children:"curriculum"})})]}),S=e.ul`
  display: flex;
...
for react by its own creators.
 <a href="https://github.com/gfouz/best-practices.git"><b>Portfolio 2023</b><a>`,H=`I am also focused on Express Js, and related libraries to afford
...
<a href="https://github.com/gfouz/pki-server-2023.git"><b>pki-server-2023</b><a>`;function et(){const i=j("(max-width: 700px)");return a(A,{children:[a(h,{image:"redplanet.jpg",center:!0,children:[t(C,{fill:"#c4b7b4",strokeColor:"#c4b7b4",width:i?"60":void 0,height:i?"60":void 0}),t(q,{variants:F,initial:"initial",animate:"animate",children:t(G,{})})]}),t(s,{variants:I,children:t(B,{children:t(O,{children:t(L,{})})})}),a(w,{children:[t(X,{children:t(Q,{})}),t(f,{children:t(s,{variants:T,children:t(u,{dangerouslySetInnerHTML:{__html:N}})})})]}),a(R,{children:[t(f,{children:t(s,{variants:_,children:t(D,{dangerouslySetInnerHTML:{__html:H}})})}),t(h,{image:"school.jpg",halfSection:!0,centerBottom:!0,children:t(s,{variants:E,children:t(Y,{})})})]}),t(h,{image:"coffeecup.png",center:!0,children:t(s,{variants:J,children:t(f,{children:t(W,{dangerouslySetInnerHTML:{__html:V}})})})}),a(K,{children:[t(p,{children:"gfouz"}),t(P,{fontSize:"15px",color:"#f2f2f2"}),t(p,{children:"portfolio"}),new Date().getFullYear()]})]})}const A=e.div`
  @font-face {
...
`,G=e.img.attrs({src:"./images/fouzJs.png",alt:"maintitle"})`
  width: 50%;
  height: auto;
