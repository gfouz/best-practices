...
`,xn=y.img.attrs({src:"./images/grass.jpg",alt:"forReact"})`
  max-width: 100%;
  height: auto;
`,En=y.img.attrs({src:"./images/greenblue.jpg",alt:"laptop"})`
  width: 100%;
  height: 100%;
  object-fit: cover;
